...
window.addEventListener('load', function () {
  var tubs = document.querySelectorAll('.sub__month-link');
  var lists = document.querySelectorAll('.sub__list');

  function changeLists(tubs, lists, jsClass, cssClass) {
    tubs.forEach(function (tub, i) {
      tub.addEventListener('click', function (evt) {
        evt.preventDefault();
        tubs.forEach(function (el) {
...
var swiper = new swiper_swiper_bundle__WEBPACK_IMPORTED_MODULE_1___default.a('.swiper', {
  navigation: {
    nextEl: '.reviews__button-next',
    prevEl: '.reviews__button-prev'
  }
});
var coachesSwiper = new swiper_swiper_bundle__WEBPACK_IMPORTED_MODULE_1___default.a('.mySwiper', {
  slidesPerView: 1,
  spaceBetween: 40,
  navigation: {
...
function setupVideo(video) {
  ...
  var media = video.querySelector('.gym__video-media');
  var button = video.querySelector('.gym__video-btn');
...
function generateURL(id) {
  var query = '?v=9TZXsZItgdw=0&autoplay=1';
